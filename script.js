$(document).ready(function(){
    ...
    $('button#freq').click(function(){
		...
		document.getElementById('yourmuni').innerHTML = '<path d="M 0 0 h ' + muniLength + '" fill="none" stroke="#174E98" stroke-width="1"></path><g transform="translate(' + muniLength + ' 0)"><circle cx="0" cy="0" r="2" fill="#174E98"></circle><text x="5" y="0" dominant-baseline="middle" font-size="4.5">You (' + muniCount + '/7)</text></g>';
	});
